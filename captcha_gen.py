...
class ValidCodeImg:
    ...
    def getValidCodeImg(self):
        ...
        font = ImageFont.truetype("data/OriginalFiles/kumo.ttf", size=self.font_size)
...
if __name__ == '__main__':
    ...
    img = ValidCodeImg(width=200, height=50, line_count=1)

    for _ in range(10):
        data, valid_str = img.getValidCodeImg()
        f = open("data/OriginalFiles/captcha_images_v1/" + valid_str + ".png", 'wb')
        f.write(data)
        f.close()

        image = tf.io.read_file("data/OriginalFiles/captcha_images_v1/" + valid_str + ".png")
